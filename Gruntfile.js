...
module.exports = function(grunt) {
    ...
    grunt.registerMultiTask("bundle", "A task that bundles DTS files", function() {
        ...
        while (queue.length > 0) {
            ...
            for(var i = 0; i < parsedFile.externalImports.length; i++) {
                var externalImport = parsedFile.externalImports[i];
    ...
    grunt.registerTask("lib", [ "clean:lib", "copy:lib", "ts_clean:lib", "bundle:lib", "copy:dts" ]);
